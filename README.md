...
<center>
This project involves undertaking tasks you have never done before.<BR>
Remember the beginning of your journey in computer science.<BR>
Look at you now; it’s time to shine!<BR><BR>
</center>

- [Team](#2-team)
  - [2.1 Team Organization and Project Management](#21-team-organization-and-project-management)
	- [2.1.1 Required Team Roles](#211-required-team-roles)
	- [2.1.2 Recommended Project Management Practices](#212-recommended-project-management-practices)
- [Mandatory part](#3-mandatory-part)
  - [3.1 What are we doing?](#31-what-are-we-doing)
  - [3.2 General requirements](#32-general-requirements)
  - [3.3 Technical requirements](#33-technical-requirements)
- [Modules](#4-modules)
  - [4.1 Web](#41-web)
  - [4.2 Accessibility and Internationalization](#42-accessibility-and-internationalization)
  - [4.3 User Management](#43-user-management)
  - [4.4 Artificial Intelligence](#44-artificial-intelligence)
  - [4.5 Cybersecurity](#45-cybersecurity)
  - [4.6 Gaming and user experience](#46-gaming-and-user-experience)
  - [4.7 Devops](#47-devops)
  - [4.8 Data and Analytics](#48-data-and-analytics)
  - [4.9 Blockchain](#49-blockchain)
  - [4.10 Modules of choice](#410-modules-of-choice)
- [Project Ideas and Examples](#5-project-ideas-and-examples)
  - [5.1 Example: Building a Pong Game](#51-example-building-a-pong-game)
  - [5.2 Gaming Projects](#52-gaming-projects)
  - [5.3 Social and Collaborative Projects](#53-social-and-collaborative-projects)
...
> **Warning:** This is a long **group project**. Poor early choices and lack of team coordination will cost a lot of time. The project and team management will strongly impact the results. All team members must actively participate and contribute to both the mandatory part and the modules.

### **2.1 Team Organization and Project Management**
...
### **2.1.1 Required Team Roles**

The team **must assign** the following roles (one person can have multiple roles if the team has 4 members):
...
>
> All roles must be clearly documented in the `README.md`.

### **2.1.2 Recommended Project Management Practices**
...
> **Info:** These practices are recommendations to help you organize your work. Find what works best for your team! The important thing is that everyone contributes and the work is well-coordinated.

> **Warning:** During evaluation, the team will be asked to explain:
...
*   **Minor:** Game statistics and match history (requires a game module).
    ...
    *   Leaderboard integration.
    ...
    > **Info:** This module requires you to have implemented at least one game (see "Gaming and user experience" section). You cannot claim this module without a functional game.
...
*   **Major:** Introduce an AI Opponent for games.
    ...
    *   You must be able to explain your AI implementation during evaluation.
    ...
    > **Info:** This module requires you to have implemented at least one game (see "Gaming and user experience" section). The AI must be able to play your game competently.
...
## **4.6 Gaming and user experience**
...
*   **Major:** Multiplayer game (more than two players).
    ...
    *   Proper synchronization across all clients.
    ...
    > **Info:** This module requires you to have implemented at least one game (see "Gaming and user experience" section). You're extending your game to support three or more players.
...
*   **Major:** Add another game with user history and matchmaking.
    ...
    *   Maintain performance and responsiveness.
    ...
    > **Info:** This module requires you to have already implemented a first game (see "Implement a complete web-based game" module above). You cannot claim this module without having a functional first game.
...
*   **Minor:** Implement a tournament system.
    ...
    *   Tournament registration and management.
    ...
    > **Info:** This module requires you to have implemented at least one game (see "Gaming and user experience" section). You cannot have tournaments without a game to play.
...
*   **Minor:** Game customization options.
    ...
    *   Default options must be available.
    ...
    > **Info:** This module requires you to have implemented at least one game (see "Gaming and user experience" section). You're adding customization to an existing game.
...
*   **Minor:** Implement spectator mode for games.
    ...
    *   Optional: spectator chat.
    ...
    > **Info:** This module requires you to have implemented at least one game (see "Gaming and user experience" section). Spectators need a game to watch.
...
## 5.1 Example: Building a Pong Game
...
> **Info:** This is just one example. You can mix and match modules from different categories to create your own unique project. The key is to ensure that your modules work together coherently and add value to your application.
...
## 5.3 Social and Collaborative Projects
...
## 5.4 Creative and Media Projects
...
## 5.5 Productivity and Tools Projects
...
> **Warning:** These are just ideas to inspire you. The key is to choose a project that:

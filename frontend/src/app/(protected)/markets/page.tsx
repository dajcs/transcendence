      ...
      <div className="flex items-start justify-between gap-4">
        ...
        <div className="shrink-0 flex flex-col items-end gap-1 text-right text-sm">
          ...
          {market.market_type === "multiple_choice" && (
            <p className="font-semibold text-blue-600 dark:text-blue-400">{(market.choices ?? []).length} choices</p>
          )}
...
export default function MarketsPage() {
  ...
  return (
    <div className="space-y-4">
      ...
      {isError && <p className="text-sm text-red-600 dark:text-red-400">Failed to load markets.</p>}

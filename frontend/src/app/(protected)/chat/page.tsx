      ...
      <div className="space-y-2">
        {conversations.map((conv) => (
          <Link
            ...
            className="flex items-center gap-3 rounded border border-gray-200 bg-white p-4 hover:border-gray-300 transition-colors"
          >
            <div className="h-10 w-10 shrink-0 rounded-full bg-gray-300 flex items-center justify-center text-sm font-medium text-gray-700">
